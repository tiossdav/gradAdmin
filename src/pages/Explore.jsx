...
import { addApplication, fetchStudents, getCourses } from "../api";
...
const Explore = () => {
  ...
  const filtered = schoolCourses.filter((course) => {
    const titleMatch = course?.title
      ?.toLowerCase()
      .includes(buttonSearchTerm.toLowerCase());
    const schoolMatch = course?.school_data?.school_name
      ?.toLowerCase()
      .includes(buttonSearchTerm.toLowerCase());
    return titleMatch || schoolMatch;
  });
  ...
  const handleSubmit = async (e) => {
    ...
    if (!studentsId || !intakeYear) {
      alert("Please select a student and intake year.");
      return;
    }
    try {
          ...
          <div className="relative w-full flex items-center">
            <input
              ...
              onChange={(e) => {
                ...
                setButtonSearchTerm(e.target.value);
              }}
          ...
          {filtered.map((course, index) => (
            ...
            >
              ...
              <div className="inline-block align-middle mt-3">
                ...
                <div className="inline-block align-middle">
                  ...
                  <p className="text-xs text-gray-600">
                    {course?.school_data?.state}, {course?.school_data?.country}
                  </p>
                </div>
              </div>
              <div className="flex flex-col mt-3">
                <div className="w-full flex flex-col gap-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm inter text-gray-700">
                      {course?.duration_year} Year(s) {course?.duration_month}{" "}
                      Month(s)
                    </p>
                  </div>
                  <div className="flex justify-between">
              ...
              <button
                ...
                className="active:scale-95 transition transform duration-200 ease-in-out flex items-center gap-3 text-sm text-white px-7 py-[10px] mt-4 bg-purple-900 rounded-md"
              >
          ...
          {selectedCourse && (
            <div className="w-[70%] inter h-[90%] " style={modalStyles.modal}>
              ...
              <div className="flex items-start gap-4 mt-4">
                <div className="relative">
                  ...
                  >
                    ...
                    {selectedCourse?.intake_year
                      ?.filter((intake) => intake.status === 1)
                      .map((intake, index) => (
              ...
              <div className="flex mt-4 items-center gap-3 w-full">
                ...
                <button
                  type="button"
                  className="active:scale-95 transition transform duration-200 ease-in-out text-sm text-white whitespace-nowrap px-6 py-[10px] bg-purple-900 rounded-md"
                >
                  Search Student
                </button>
              </div>
