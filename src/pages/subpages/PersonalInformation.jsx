      ...
      <div className="grid grid-cols-2 gap-4">
        <div className=" w-full">
          ...
          <div className="border border-gray-200 p-4 rounded-md">
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <p className="text-gray-900 text-sm">12 January 1998</p>
            </div>
            <div className="flex justify-between items-center py-3">
            ...
            <div className="flex justify-between items-center py-3">
              ...
              <p className="text-gray-900 text-sm">Bachelors Degree</p>
            </div>
            <div className="flex justify-between items-center py-3">
        ...
        {isPersonaOpen && (
          <div style={modalStyles.overlay} className="flex flex-col">
            ...
            >
              <h6 className=" mt-1 font-semibold">Edit Personal Information</h6>
              <form className="mt-5">
                <div className="w-full">
